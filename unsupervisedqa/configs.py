...
MAX_PARAGRAPH_CHAR_LEN_THRESHOLD = 600000
MAX_QUESTION_CHAR_LEN_THRESHOLD = 2000
## remove items with more words than this
MAX_PARAGRAPH_WORD_LEN_THRESHOLD = 4000
MAX_QUESTION_WORD_LEN_THRESHOLD = 50
MIN_QUESTION_WORD_LEN_THRESHOLD = 8
## remove items that have words with more characters than this
MAX_PARAGRAPH_WORDSIZE_THRESHOLD = 30
MAX_QUESTION_WORDSIZE_THRESHOLD = 30
