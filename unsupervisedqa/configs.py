...
MAX_PARAGRAPH_CHAR_LEN_THRESHOLD = 200000
MAX_QUESTION_CHAR_LEN_THRESHOLD = 2000
## remove items with more words than this
MAX_PARAGRAPH_WORD_LEN_THRESHOLD = 40000
MAX_QUESTION_WORD_LEN_THRESHOLD = 400
## remove items that have words with more characters than this
MAX_PARAGRAPH_WORDSIZE_THRESHOLD = 200
MAX_QUESTION_WORDSIZE_THRESHOLD = 200
...
CONSTITUENCY_MODEL = "https://s3-us-west-2.amazonaws.com/ai2-s2-scispacy/releases/v0.2.4/en_core_sci_md-0.2.4.tar.gz"
